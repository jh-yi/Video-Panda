...
from videopanda.model import VideoPandaLlamaForCausalLM
...
def load_pretrained_model(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    ...
    if 'videopanda' in model_name.lower():
        # Load Video-Panda model
    ...
    if 'videopanda' in model_name.lower():
        ...
        video_processor = video_tower.image_processor
