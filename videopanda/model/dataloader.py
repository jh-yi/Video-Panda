# Adapted from https://github.com/mbzuai-oryx/VideoGPT-plus/blob/main/videogpt_plus/model/dataloader.py
...
def _get_rawvideo_dec(video_path, image_processor, video_processor, max_frames=8, frame_resolution=224,
    ...
    if num_frames > 0:
        ...
        # if t_stride == 0:  #  only exist in TGIF
        #     t_stride = num_frames // max_frames
        ...
        all_images = [f for f in vreader.get_batch(sample_pos).numpy()]
